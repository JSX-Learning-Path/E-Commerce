    ...
    <header className={`site-header site-header-${theme}`}>
      <div className="container-fluid px-5">
        <div className="header-shell">
          ...
          <button
            className={`header-burger d-md-none ${isMobile ? "open" : ""}`}
            aria-label="Toggle menu"
            aria-expanded={isMobile}
            onClick={() => setIsMobile((prev) => !prev)}
          >
            <RxHamburgerMenu />
            <span className={`header-burger-icon ${isMobile ? "open" : ""}`} />
          </button>

          <div className="header-search d-inline">
            <SearchBar theme={theme} />
          </div>

          <nav className="header-nav d-flex" aria-label="Primary navigation">
